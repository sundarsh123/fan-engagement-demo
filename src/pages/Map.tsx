...
import fanengagementGeo from '../data/fanengagement.geo.json'
import config from '../aws-exports'

const mapName = 'FanEngagement'
const CollectionName = 'FanEngagement'
const data = fanengagementGeo as GeoJSON.FeatureCollection<GeoJSON.Geometry>
                        ...
                        <Popover.Panel className="w-48 p-2 text-xs bg-white rounded shadow-lg">
                          <div>
                            <h3 className="font-bold tracking-wide uppercase">
                              Unicorn Music Festival at The Venetian
                            </h3>
                            <p className="mt-3">
                              The Venetian is home to four theaters: The Opaline Theatre, The Palazzo Theatre, The Sands Showroom, and The Venetian Theatre.
                            </p>
                          </div>
                        </Popover.Panel>
                      </Popover>
